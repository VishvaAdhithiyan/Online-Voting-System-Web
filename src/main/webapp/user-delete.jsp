...
<%@page import="java.sql.*" %>
 ...
 <%
        String profile = request.getParameter("Name1");
        %>
<html>
<head>
...
<script>
        ...
        Swal.fire({
  		  title: "Are you willing to delete the profile <%out.print(profile);%> ?",
  		  ...
  		  if (result.isConfirmed) {
  			  ...
  			  window.location = 'user-form1.jsp?Name1=<%=profile%>';
  		  }
  		  else
  		{
			...
			<table class="table table-bordered">
				...
				<tbody>
					<tr>
                                 ...
                                 <td><a href="user-form1.jsp?Name1=<%=Name1%>">Delete</a></td>
